...
export default function Posts({ post }) {
  ...
  const likePost = async (isStarred, postId, userId) => {
    let res = await fetch("https://myapp-64rs.onrender.com/api/specific-post", {
      method: "GET",
      headers: {
        postId: `${postId}`,
        userId: `${userId}`,
    ...
    if (data.isStarred) {
      ...
      let res1 = await fetch("https://myapp-64rs.onrender.com/api/unstar", {
        method: 'POST',
        headers: {
      ...
      let res2 = await fetch("https://myapp-64rs.onrender.com/api/star", {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const bookmarkPost = async (bookmarkType, postId, userId) => {
    let res = await fetch("https://myapp-64rs.onrender.com/api/check-bookmark", {
      method: 'GET',
      headers: {
        userId: `${userId}`,
        bookmarkId: `${postId}`,
    ...
    if (data.response === 'exist') {
      ...
      let res1 = await fetch("https://myapp-64rs.onrender.com/api/bookmark", {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      let res2 = await fetch("https://myapp-64rs.onrender.com/api/bookmark", {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
